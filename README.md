...
| :--- | :--- | :--- |
| **Frontend** | ![Next.js](https://img.shields.io/badge/Next.js-black?style=flat-square&logo=next.js&logoColor=white) | React-based SSR/SSG framework for a fast and SEO-friendly interface. |
| **Backend** | ![Node.js](https://img.shields.io/badge/Node.js-43853D?style=flat-square&logo=node.js&logoColor=white) ![Express.js](https://img.shields.io/badge/Express.js-000000?style=flat-square&logo=express&logoColor=white) | REST API architecture and server-side logic. |
| **Database & Auth** | ![Firebase](https://img.shields.io/badge/Firebase-FFCA28?style=flat-square&logo=firebase&logoColor=black) | Real-time database, hosting, and authentication services. |
| **Styling** | ![TailwindCSS](https://img.shields.io/badge/Tailwind_CSS-06B6D4?style=flat-square&logo=tailwindcss&logoColor=white) | Modern and responsive design styles. |
...
3.  **Auto Matching:** On the determined date, the system runs algorithms to assign the most compatible people to each other.
4.  **Gifting Time:** Matched students meet on campus to exchange gifts and gain a new friendship.
...
* **Yusuf Samet Karakurt** 
* **Ali Bayrak**
* **Şahin Akgün**

---
© 2025 Kampüs Ağacı. All rights reserved.
